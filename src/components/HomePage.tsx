    ...
    <main className="mx-auto max-w-xl px-4 py-8 sm:py-12">
      <header className="mb-6 text-center">
        <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-gray-900 leading-snug">
          50cc・125ccバイクの通行禁止区間マップ
        </h1>
        <p className="mt-2 text-gray-600">
          <span className="font-bold">🏍️ BikeRoute</span> — 原付・バイクが通れない道を出発前にチェック
        </p>
      ...
      <div className="mt-10 border-t border-gray-100 pt-8">
        ...
        <ul className="space-y-2">
          {[
            ...
            { href: "/articles/nagoya-bike-restriction", label: "名古屋・愛知のバイク通行禁止区間まとめ（名古屋高速）" },
            { href: "/articles/fukuoka-bike-restriction", label: "福岡のバイク通行禁止区間まとめ（都市高速・若戸トンネル）" },
            { href: "/articles/hyogo-bike-restriction", label: "兵庫のバイク通行禁止区間まとめ（阪神高速神戸線・第二神明）" },
            { href: "/articles/saitama-bike-restriction", label: "埼玉のバイク通行禁止区間まとめ（首都高・外環道・関越）" },
            { href: "/articles/chiba-bike-restriction", label: "千葉のバイク通行禁止区間まとめ（アクアライン・湾岸線）" },
            { href: "/articles/ishikawa-bike-restriction", label: "石川のバイク通行禁止区間まとめ（のと里山海道・能登）" },
            { href: "/articles/shizuoka-bike-restriction", label: "静岡のバイク通行禁止区間まとめ（新東名・伊豆ツーリング）" },
            { href: "/articles/hiroshima-bike-restriction", label: "広島のバイク通行禁止区間まとめ（広島高速・しまなみ海道）" },
            { href: "/articles/hokkaido-bike-restriction", label: "北海道のバイク通行禁止区間まとめ（道央道・ツーリング注意）" },
            { href: "/articles/tunnel-bike-restriction", label: "全国の二輪車通行禁止トンネルまとめ（山手・川崎・関門）" },
